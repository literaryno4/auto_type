    ...
    def write(self):
        ...
        with open(self.file_name, "w") as f:
            ...
            for types in range(num_type):
                try:
                    ques_style = input("请输入问题页码和标号风格（例如：P533,Q11.）的533：")
                except:
                    print(sys.exc_info())
                    ques_style = input("请输入问题页码和标号风格（例如：P533,Q11.）的533：")
                ...
                #ans_style = 'Q'
                ans_style = "TP"#input("请输入答案页码和标号风格（例如：TP or P）：")
                ...
                for i in range(num_question):
                    ...
                    f.write("题目页码：" + "P" + ques_style + num_style + auto_type.next_line)
                    ...
                    f.write("答案：" + auto_type.next_line
                            )
                #    if i+1 in subques_dict:
                ...
                #            f.write(auto_type.next_line)
                    ...
                    f.write(auto_type.next_line + "\n")
                    bango += 1
                subques_sum_list.append(num_question - num_have_subques + sum(subques_dict.values()))
                self.subques_dict = {}
                print("This round has done!\n\n\n\n\n")
            print("总共有小题：%d 个" % sum(subques_sum_list))
